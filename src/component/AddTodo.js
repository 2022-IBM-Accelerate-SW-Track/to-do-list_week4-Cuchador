...
class AddTodo extends Component {
  ...
  handleSubmit = (event) => {
    ...
    if (this.state.content.trim()) {
      //This snippet of code is creating a json object that will be used as a body request 
      //to be sent to the addItem function located in our Express application. 
      const jsonObject = {
        id: this.state.id,
      ...
      //This snippet of code is making a POST request the addItem function located 
      //in our Express Application and returning a response message.
      Axios({
        method: "POST",
        url: "http://localhost:8080/add/item", //idk if port is correct
        data: {jsonObject},
        headers: {
